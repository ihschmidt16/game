...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const solvedToBlur = document.querySelectorAll("body > :not(#solved-popup):not(#share-button-pop):not(#score-container");
  ...
  let cur_phrase, lin_idx, guessing, last_key_is_del, last_key_is_create, formattedDateX, puzScore, timerId, seconds,
  ...
  function startTimer() {
    ...
    timerId = setInterval(() => {
      ...
      puzScore = Math.max(0, puzScore - 0.1);
      updateScoreDisplay(puzScore);
    }, 1000);
  }
