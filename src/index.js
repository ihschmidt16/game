...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const pauseToBlur = document.querySelectorAll("body > :not(#pause-popup):not(#info-popup):not(#solved-popup):not(#logo):not(#date-display):not(#info-button):not(#play-popup):not(#menuIcon):not(#dropdownMenu):not(#menuCloseArrow)");
  const playPopup = document.getElementById("play-popup")
  const playToBlur = document.querySelectorAll("body > :not(#play-popup):not(#info-popup):not(#solved-popup):not(#logo):not(#date-display):not(#info-button):not(#pause-popup):not(#menuIcon):not(#dropdownMenu):not(#menuCloseArrow)");
