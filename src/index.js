...
document.addEventListener('DOMContentLoaded', () => {
  ...
  let cur_phrase, lin_idx, formattedDateX, puzScore, pause_showing, LA_Typed, RA_Typed, num_arrX, str_arrX, guess_arrX,
  ...
  function checkIfCorrect() {
    ...
    if (correct) {
      ...
      solvedBlur(true);
      // var audio = document.getElementById("solveSound");
      // audio.play();
      confetti({
        particleCount: 100,
        spread: 70,
