...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const pauseToBlur = document.querySelectorAll("body > :not(#pause-popup):not(#info-popup):not(#solved-popup):not(#logo):not(#date-display):not(#info-button):not(#play-popup):not(#menuIcon):not(#dropdownMenu)");
  const playPopup = document.getElementById("play-popup")
  const playToBlur = document.querySelectorAll("body > :not(#play-popup):not(#info-popup):not(#solved-popup):not(#logo):not(#date-display):not(#info-button):not(#pause-popup):not(#menuIcon):not(#dropdownMenu)");
  const dropdown = document.getElementById("dropdownMenu");
  const tbody = document.getElementById("menuItems");
  const menuIcon = document.getElementById("menuIcon");
  const menuToBlur = document.querySelectorAll("body > :not(#menuIcon):not(#dropdownMenu)");
  ...
  function updateDisplay() {
    container.innerHTML = '';
    // testValue.textContent = first_lins;
