...
if (window.innerHeight < window.innerWidth) {
    BOXROWS0 = 12;     // number of box rows
    BOXCOLS0 = 20;    // number of box cols
} else {
    BOXROWS0 = 15;     // number of box rows
    BOXCOLS0 = 16;    // number of box cols
}
...
// EXPORTS
return { BOXROWS, BOXCOLS, num_arr, str_arr, guess_arr, last_lins, first_lins, underline1, underline2 };
