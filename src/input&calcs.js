...
// file exporting from: (call it source.js)
// export const XXX = value
// export const YYY = value
// export default{XXX:XXX}
// export default{YYY:YYY}

// file importing to:
// import {XXX, YYY} from "./source.js"
...
const BOXROWS = 7     // number of box rows
const BOXCOLS = 24    // number of box cols
const LRSPA = (WIDTH-(BOXCOLS*SQW)-((BOXCOLS-1)*LETTSPA))/2     // left and right spacing to boxes
...
const num_arr = create2DArray(rows, cols);
...
// export var {num_arr:num_arr};
// export default {BOXCOLS:BOXCOLS};


// export default num_arr

console.log(num_arr)

export {num_arr, BOXROWS, BOXCOLS}
